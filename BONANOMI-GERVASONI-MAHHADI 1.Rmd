...
------------- | -------------| ---------
baseline_value| Valore di base della frequenza cardiaca fetale (FHR) |  
accelerations|Numero di accelerazioni della FHR | numero accelerazioni medio per minuto
fetal_movement|
