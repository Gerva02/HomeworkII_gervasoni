...
<div style="text-align: justify;">
<br><br>
Ora implementiamo un EM di normali senza specificare il numero dei gruppi
```{r}
...
```
l'algoritmo EM non riesce a stimare modelli complessi come VVV a causa della
bassa disponibilità di u.s. (nemmeno VVV con k=3)
VEV,7 e EVV,3 (sono molto vicini tra loro)
...
```
secondo il BIC (non accurato come ICL, in quanto non tiene conto dell'entropia) risulta k=8 e modello VEV
...
```
la sensitivity è molto alta solo nella classe "Normale"
...
rappresentazione in nero delle u.s. missclassified
...
```
più è grande il pallino più l'unità 
