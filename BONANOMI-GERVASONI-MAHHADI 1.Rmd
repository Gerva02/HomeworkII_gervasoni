...
```
In definitiva possiamo dire che l'EM è molto instabile e poco robusto per cui diventa cruciale la scelta dei valori iniziali). Sia tramite ICL che con il BIC il model based clustering fornisce 
