...
Al contrario per quanto riguarda l'entropia (356) ed l'entropia relativa (0.15) possiamo dedurre che il modello risulta affidabile. <br>
...
Al contrario in termini di allocazione delle unità statistiche si denota un peggioramento osservabile dalla presenza di incertezza maggiore in ciascuna unità statistica e da un'entropia assoluta (1019) e relativa (0.25) superiore. 
```{r,echo=FALSE}
