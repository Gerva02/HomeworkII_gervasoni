...
Il dataset non presenta valori mancanti. Valutando la distribuzione delle variabili abbiamo visto come quelle di conteggio naturalmente seguono una distribuzione assimilabile a quella di Poisson di conseguenza si è optato per escluderle dalle successive analisi. È stata esclusa anche la variabile *histogram_tendency* poichè fattoriale.
Le variabili *percentage_of_time_with_abnormal_long_term_variability* e *histogram_variance* non son state considerate perchè non hanno comportamento normale. Le restanti variabili escluse dimostravano una pronunciata asimmetria.
