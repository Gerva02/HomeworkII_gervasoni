...
Nel nostro caso applichiamo l'algoritmo smote per allenare il modello con 600 osservazioni per la classe dei patologici (quella di nostro interesse) 300 per la classe dei "dubbiosi" e facciamo undersampling in modo che il classificatore venga allenato su 300 "Normali", per ogni classe minoritaria. Inoltre utilizziamo il default di vicini prossimi (nearest neighbor) che è `k = 5`
...
Dunque il nostro classificatore risulta utile a dare i
