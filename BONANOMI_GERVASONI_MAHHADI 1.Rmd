...
<br><br>
---------|**Reference**|-----------------
 **Prediction**  | Normale  | Sospetto | Patologico
Normale| 494| 61|26
Sospetto|1| 20|9
Patologico| 0|1|19
...
##### 5.3.3)MDA classificazione sospetti come sani o malati
...
##### 5.3.4)MDA under/oversampling
Dalle precedenti analisi abbiamo visto che i modelli faticano a classificare la classe dei sospetti(sensitivity troppo bassa) e tendono a inserire i casi sospetti nella classe dei normali(7 su 8). Questo è dato che i casi sospetti mostrano valori anomali che necessitano di ulteriori analisi. Alla luce delle sopraindicate difficoltà, servendoci unicamente delle variabili a nostra disposizione, abbiamo deciso di costruire un modello con il solo scopo di classificare un feto come patologico o non patologico senza suddividere i dati in normale e sospetto.
```{r,echo=FALSE}
