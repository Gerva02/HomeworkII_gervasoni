...
Tramite l'utilizzo di SMOTE e undersampling e un classificatore MDA otteniamo un risultato migliore per classi minoritarie, ma risulta ovvio che lo scarso numero osservazioni e l'accuratezza comunque relativamente bassa rendano il nostro classificatore non adatto ad usi medici, ma potrebbe diventarlo tramite metodi di classificazione più sofisticata che possono permettere di altri tipi di dati.prova
